...
**최종 수정일**: 2025-08-20  
**변경 이력**: @dataclass에서 Pydantic BaseModel로 변경
...
class DocumentTemplate(BaseModel):
    ...
    form_fields: Dict[str, Any] = Field(default_factory=dict) # 동적 폼 필드 스키마
...
### 🔲 Phase 1: 기본 구조
- [ ] 1. common/auth.py에 전자결재용 Enum 추가 (DocumentStatus, ApprovalAction, DocumentVisibility)
- [ ] 2. Pydantic BaseModel로 도메인 모델 생성 (5개 파일)
- [ ] 3. Beanie Document로 데이터베이스 모델 구현 (5개 파일)
